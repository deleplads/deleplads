  ...
  return (
    <section className="privacy">
      ...
      <p>
        ...
        <br></br><br></br>
        Det er ikke et krav, at vores virksomhed har en ekstern DPO, men hvis du har spørgsmål til behandlingen af dine personoplysninger, så kan du kontakte os via
        [mailadresse].
        <br></br><br></br>
        ...
        <br></br>
        Når du besøger vores hjemmeside, så anvender vi cookies for at hjemmesiden kan fungere, hvilket du kan læse mere om i vores <a href="/cookies">cookiepolitik</a>.
        <br></br><br></br>
        ...
        <br></br><br></br>
        Du kan læse mere om dine rettigheder i Datatilsynets vejledning om de registreredes rettigheder, som du finder på <a href="www.datatilsynet.dk">www.datatilsynet.dk</a>.
        <br></br><br></br>
